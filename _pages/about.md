...
- ``ICLR 2025`` [Tool-Planner: Task Planning with Clusters across Multiple Tools](https://arxiv.org/abs/2406.03807), Yanming Liu, Xinyue Peng, Jiannan Cao, Shi Bo, Yuwei Zhang, **Tianyu Du***, Sheng Cheng, Xun Wang, Jianwei Yin, Xuhong Zhang.
